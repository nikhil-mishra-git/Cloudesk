...
const getFileIconInfo = (type = '') => {
    switch (type.toLowerCase()) {
        ...
        default:
            return { icon: <FaFileAlt size={30} />, gradient: 'from-zinc-400 to-zin-600' };
    }c
};
        ...
        <div className="relative bg-white rounded-2xl shadow transition-all duration-300 w-full max-w-sm overflow-hidden group">
            ...
            <div className="px-6 py-4">
                ...
                <div className="mt-4 flex justify-between items-center">
                    <span className="text-xs font-medium px-2 py-0.5 bg-gray-100 rounded text-gray-600 uppercase tracking-wide">
                        {fileType}
                    </span>
