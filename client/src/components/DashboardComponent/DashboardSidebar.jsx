...
const DashboardSidebar = () => {
    return (
        <aside className="w-64 h-full bg-white shadow-sm rounded-3xl px-6 py-8 flex flex-col justify-between border border-gray-100">
            <div>
                <div className="flex items-center gap-3 mb-6 px-4 pb-4">
                    <TbLayoutDashboard className="text-blue-600 text-2xl" />
                    <h2 className="text-2xl font-semibold text-zinc-600">Overview</h2>
                </div>
            ...
            <div className="text-xs mt-10 text-gray-400 text-center pt-6 border-t border-gray-100">
                © 2025 Cloudesk
            </div>
        </aside>
    );
